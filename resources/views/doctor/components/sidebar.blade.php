<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        ...
        <a class="sidebar-brand brand-logo-mini" href="#"><img src="admin/assets/images/logo-mini.svg"
                alt="logo" /></a>
    </div>
    <ul class="nav">
            ...
            <div class="profile-desc">
                <div class="profile-pic">
                    <div class="count-indicator">
                        <img class="img-xs rounded-circle " src="doctorimage/{{ Auth::guard('doctor')->user()->image }}"
                            alt="">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ url('doctor-check-records') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-account-card-details"></i>
                </span>
                <span class="menu-title"> Patient's records</span>
            </a>
        </li>
